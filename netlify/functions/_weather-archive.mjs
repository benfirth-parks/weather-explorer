...
function findHeaderIndex(lines) {
  const measurementTokens = new Set([
    ...
    "ws", "wspd", "windspeed",
    "avgws", "avgwspd", "avgwindspeed", "averagewindspeed", "averagewspd",
...
function parseFtsCsv(text) {
  ...
  for (const line of lines.slice(headerIndex + 1)) {
    ...
    assign("windSpeedGust", [
      ...
      "Peak Wind", "PeakWind", "Peak Wind Speed", "PeakWspd", "Peak Wspd",
      "Peak Gust", "PeakGust",
    ...
    assign("windDirAvg", [
      ...
      "Peak Dir", "PeakDir", "Peak Wind Dir", "Peak Wind Direction"
    ]);
