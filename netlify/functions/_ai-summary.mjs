...
- Call out ONE clear outlier if there is one — a station that broke well outside the band/region range for temperature, wind, or precipitation. Station names ARE permitted when naming an outlier (use the station's \`name\` field verbatim). Don't force an outlier if none stands out.

WHAT TO AVOID:
- Don't name stations for routine readings that fit inside the band/region range.
- Don't mention operational groups or agencies (no "Visitor Safety", "VS", "Fire", "Banff Fire").
