...
Rules:
- HARD LIMIT: 4–5 sentences total, roughly 140 words maximum. Be terse.
...
- TEMPORAL EVOLUTION IS MANDATORY: at least ONE sentence must describe how the weather CHANGED through the observation window, not just where it ended. Use the per-station \`trend\` object (early vs late halves) plus \`temp_high_hour_utc\` / \`temp_low_hour_utc\`. Prefer plain-language change verbs: "warmed", "cooled", "backed to", "veered to", "strengthened", "eased", "picked up in the second half", "tapered off", "peaked mid-afternoon", "lows just before dawn". Compare the two halves quantitatively when magnitudes differ meaningfully: "alpine gusts rose from 20–35 to 45–65 km/h", "below-treeline precipitation was front-loaded (3–5 mm early, <1 mm late)", "alpine flow backed from W to SSW". Times are recorded in UTC — the observation window covers roughly the past 24 h ending now; translate hour-of-day into rough English descriptors ("overnight", "morning", "midday", "afternoon", "evening") based on Mountain Time (UTC-6 in summer, UTC-7 in winter) but do NOT print absolute clock times.
